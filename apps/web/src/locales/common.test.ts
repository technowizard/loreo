...
describe('common locale phase 7 coverage', () => {
  it.each(phaseSevenKeys)('defines %s in English and Indonesian locales', (key) => {
    expect(getValue(enCommon, key)).toEqual(expect.any(String));
    expect(getValue(idCommon, key)).toEqual(expect.any(String));
  });
});

const phaseEightKeys = [
  'common.error.label',
  'common.error.title',
  'common.error.retry',
  'common.notFound.title',
  'common.notFound.goBack',
  'common.dialog.close',
  'reader.highlights.title',
  'reader.highlights.description',
  'reader.notes.highlightColor',
  'reader.notes.editNote',
  'reader.notes.addNote',
  'reader.notes.addYourThoughts',
  'reader.notes.deleteNote',
  'reader.notes.save',
  ...
  'tags.tagInput.noTagsAvailable',
  'tags.tagInput.noMatchingTags',
  'tags.tagInput.maxTagsReached',
  'tags.tagInput.tagCount_one',
  'tags.tagInput.tagCount_other',
  'tags.toasts.creating',
  'tags.toasts.groupCreated',
  'tags.toasts.updating',
  'tags.toasts.groupUpdated',
  'tags.toasts.deleting',
  'tags.toasts.groupDeleted',
  'tags.toasts.tagCreated',
  'tags.toasts.tagUpdated',
  'tags.toasts.tagDeleted',
  'tags.toasts.fixValidation',
  'tags.toasts.failedUpdateGroup',
  'tags.toasts.failedCreateGroup',
  'tags.toasts.failedUpdateTag',
  'tags.toasts.failedCreateTag',
  'tags.toasts.failedDeleteType',
  'tags.toasts.tagsDeleted_one',
  'tags.toasts.tagsDeleted_other',
  'tags.toasts.failedDeleteTags',
  'tags.toasts.tagMoved',
  'tags.toasts.tagsMoved_one',
  'tags.toasts.tagsMoved_other',
  'tags.toasts.nameConflict',
  'tags.toasts.failedMoveTags',
